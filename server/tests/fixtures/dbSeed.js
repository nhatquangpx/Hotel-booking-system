...
async function seedDatabaseFixture() {
  ...
  const [admin, owner, staff, guest, guest2, otherOwner, unassignedStaff] =
    await User.insertMany([
      ...
      },
      {
        ...
        idImageFrontUrl: "local:private:id-cards/seed-id-front.jpg",
        idImageBackUrl: "local:private:id-cards/seed-id-back.jpg",
      },
      {
        name: "Guest Two",
  ...
  const pendingBooking = await Booking.create({
    ...
    guestIdImageFrontUrl: "local:private:id-cards/seed-id-front.jpg",
    guestIdImageBackUrl: "local:private:id-cards/seed-id-back.jpg",
    finalAmount: 1000000,
    basePrice: 1000000,
    discountAmount: 0,
