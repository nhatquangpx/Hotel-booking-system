...
import { VIEW_MODES } from '../utils/userListHelpers';

const VIEW_OPTIONS = [
  { value: VIEW_MODES.LIST, label: 'Danh sách', Icon: ViewListIcon },
  { value: VIEW_MODES.ROLE, label: 'Theo vai trò', Icon: GroupIcon },
  { value: VIEW_MODES.HOTEL, label: 'Theo khách sạn', Icon: HotelIcon },
];

const ViewModeSelector = ({ value, onChange }) => (
  <div className="view-mode-selector" role="tablist" aria-label="Chế độ hiển thị">
