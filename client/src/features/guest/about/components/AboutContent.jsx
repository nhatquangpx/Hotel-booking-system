    ...
    <div className="about-container">
      ...
      <div className="about-section">
        ...
        <div className="about-image">
          <img src={IMAGE_PATHS.ABOUT_MISSION} alt="Sứ mệnh của StayJourney" />
        </div>
      </div>
      ...
      <div className="about-section reverse">
        ...
        <div className="about-image">
          <img src={IMAGE_PATHS.SLIDE_2} alt="Giá trị cốt lõi" />
        </div>
      </div>
        ...
        <div className="team-grid">
          <div className="team-member">
            <div className="member-image">
              <img src={IMAGE_PATHS.TEAM_MEMBER_2} alt="CEO" />
            </div>
          ...
          <div className="team-member">
            <div className="member-image">
              <img src={IMAGE_PATHS.TEAM_MEMBER_1} alt="COO" />
            </div>
            <h3>Đoàn Nhật Quang</h3>
          ...
          <div className="team-member">
            <div className="member-image">
              <img src={IMAGE_PATHS.TEAM_MEMBER_3} alt="CTO" />
            </div>
            <h3>Đoàn Nhật Quang</h3>
